...
The {{company_name}} Team`,
  ...
  // Fetch the email template data from the API
  useEffect(() => {
    axios
      .get("/api/email-templates/1") // Replace with your actual API endpoint
      .then((response) => {
  ...
  // Handle saving changes to the email template
  const handleSave = () => {
    setIsEditing(false);

    axios
      .put(`/api/email-templates/${editingTemplate.id}`, editingTemplate) // Replace with your actual API endpoint
      .then((response) => {
        console.log("Template saved successfully:", response.data);
        setEditingTemplate(response.data); // Update the template in the state
      })
      .catch((error) => {
